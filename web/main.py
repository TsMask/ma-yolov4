...
async def get_index(request: Request):
    return tmp.TemplateResponse('index.html', {'request': request, 'title': '基于 ModelArts 平台部署 - YOLO V4'})
...
async def post_infers(request: Request,
    ...
    url = "https://772cc4556c7047dc9cfcb05814d147c9.apig.cn-north-4.huaweicloudapis.com/v1/infers/bd0a4c19-af77-47d5-b11a-85ea751f8a80"
    data = {
        "min_score": min_score,
